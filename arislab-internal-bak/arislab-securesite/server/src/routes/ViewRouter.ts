...
import CurrentStoreBalanceController from "../controllers/CurrentStoreBalanceController";
const currentStoreBalance = new CurrentStoreBalanceController();
...
router.get("/reports/store-balance", (req: any, res: any) =>
  currentStoreBalance.storeBalances(req, res)
);
