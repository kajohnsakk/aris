...
const NavbarWrapperLayout = ({ classes, children, navbar, settings, navbarTheme, navbarOpenFolded, navbarCloseFolded, navbarCloseMobile }) => {
...
export default withStyles(styles, { withTheme: true })(connect(mapStateToProps, mapDispatchToProps)(NavbarWrapperLayout));
