export default function ({ url = "", storeName = "" }) {
                                                    ...
                                                    >
                                                        <div>
                                                            <h1
                                                                ...
                                                                align="center"
                                                            >
                                                                <strong>@${storeName}</strong> has <span class="il">invited</span> you to join the store
                                                            </h1>
                                                            ...
                                                            <p
                                                                ...
                                                                align="left"
                                                            >
                                                                @${storeName} has <span class="il">invited</span> you to join the store on Arislab.
                                                            </p>
                                                            <p
                                                                style="
                                                                    word-wrap: normal;
                                                                ...
                                                                align="left"
                                                            >
                                                                This <span class="il">invitation</span> will expires in 3 days.
                                                            </p>
